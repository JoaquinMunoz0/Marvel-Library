...
class _VariantesPageState extends State<VariantesPage> {
  ...
  void initState() {
    ...
    marvelService = MarvelService(
      'https://gateway.marvel.com/v1/public/characters?nameStartsWith=${Uri.encodeComponent(widget.baseName)}&limit=100&offset=[0, 200, 400, 600, 800]&ts=1751930069&apikey=40a835d209da33c1145163d7b5d39c76&hash=a9641d5a746d417c9e5a8203a8c24198',
    );
    loadVariantes();
  }
